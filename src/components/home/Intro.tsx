  ...
  return (
    <section className="relative w-full bg-white">
      ...
      <div className="container relative z-10 flex flex-col items-center text-center text-text-default">
        ...
        <h1 className="font-extrabold lg:text-[42px] lg:leading-[54px] uw:cap-text-42 uw:cap-leading-54">
          Scale Your Team With High Quality, Vetted Professionals
        </h1>

        <p className="font-normal lg:mt-[38px] lg:max-w-[801px] lg:text-[24px] lg:leading-[32px] uw:cap-mt-38 uw:cap-max-w-801 uw:cap-text-24 uw:cap-leading-32">
        ...
        <p className="font-light lg:max-w-[494px] lg:text-[24px] lg:leading-[26px] uw:cap-max-w-494 uw:cap-text-24 uw:cap-leading-26 relative -uw-top-100">
